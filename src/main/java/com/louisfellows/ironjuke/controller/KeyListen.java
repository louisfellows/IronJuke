...
public class KeyListen implements KeyListener {
    ...
    private void checkForCompletedKeys() {
        if (m_Keys.size() == 0) {
            ...
            String s = m_Keys.get(0).toString() + m_Keys.get(1).toString() + " :  ";
            m_Controller.selUpdated(s);
        } else if (m_Keys.size() == 3) {
            String s = m_Keys.get(0).toString() + m_Keys.get(1).toString() + m_Keys.get(2).toString() + ":  ";
            m_Controller.selUpdated(s);
        } else if (m_Keys.size() == 4) {
            String s = m_Keys.get(0).toString() + m_Keys.get(1).toString() + m_Keys.get(2).toString() + ":" + m_Keys.get(3).toString() + " ";
            m_Controller.selUpdated(s);
